    ...
    <div class="list">
      <Table :columns="columns1" :data="data1">
        ...
        <template slot="action">
          <span class="bt" @click="showRemind">提醒</span>
        </template>
      </Table>
    </div>
    <Modal
      ...
      :width="800"
    >
      <RemindList v-if="modal_type === 'RemindList'" />
      <Remind v-if="modal_type === 'Remind'" />
    </Modal>
  </div>
</template>

<script>
  import RemindList from '@/components/vip-list2/remind-list'
  import Remind from '@/components/vip-list2/remind'
  export default {
    name: 'VipServiceList',
    components: {
      RemindList,
    ...
    methods: {
      showRemindList() {
        ...
        this.modal_title = '提醒记录'
        this.modal_type = 'RemindList'
      },
      showRemind() {
        this.is_show_modal = true
        this.modal_title = '服务提醒'
        this.modal_type = 'Remind'
      },
    },
  }
</script>
