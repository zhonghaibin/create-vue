<template>
  <div class="VipServicePeriod">
    <div class="list-top">
      ...
      <div class="bt-right">
        <Button class="bt" type="primary" @click="showServiceRemind">
          添加服务提醒
        </Button>
      </div>
    </div>
    ...
    <Modal
      ...
      :width="600"
    >
      <ServiceRemind v-if="modal_type === 'ServiceRemind'" />
    </Modal>
  </div>
</template>

<script>
  import ServiceRemind from '@/components/vip-list2/service-remind'
  export default {
    ...
    methods: {
      showServiceRemind() {
        ...
        this.modal_title = '添加服务提醒'
        this.modal_type = 'ServiceRemind'
      },
    },
  }
</script>
