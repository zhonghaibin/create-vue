  ...
  <div class="CardTable">
    <div class="left-box">
      <div class="search">
        ...
        <div class="right">
          <div class="add-bt" @click="showModal('时间设置', 'CardTime', 400)">
            时间设置
          </div>
          <div
            class="add-bt"
            @click="showModal('新增预约', 'Appointment', 600)"
          >
            新增预约
          </div>
        </div>
    ...
    <Modal
      ...
      :width="modal.width"
    >
      <CardTime v-if="modal.type === 'CardTime' && modal.show" />
      <Appointment v-if="modal.type === 'Appointment' && modal.show" />
      <CardInfo v-if="modal.type === 'CardInfo' && modal.show" />
    </Modal>
  </div>
</template>
...
<script>
  ...
  export default {
    name: 'CardTable',
    components: { CardTime, Appointment, Calendar, CardInfo },
    props: {
      memberInfo: {
        type: Object,
        default: () => {},
    ...
    methods: {
      ...
      save() {},
      setHeight() {
        let divHeight = window.innerHeight - 308
