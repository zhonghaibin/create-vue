<template>
  <div class="CourseTable">
    <div class="search">
      ...
      <div class="right">
        <div class="add-bt" @click="showModal('时间设置', 'CourseTime', 600)">
          时间设置
        </div>
        <div
          class="add-bt"
          @click="showModal('课室管理', 'ClassRoomList', 600)"
        >
          课室管理
        </div>
      </div>
        ...
        <div class="column1" :style="{ left: column1.left + 'px' }">
          <table class="new_tb2">
            <thead>
              <tr class="title1">
                <th colspan="4">
                  <Icon style="font-size: 28px" type="md-time" />
                </th>
              </tr>
              <tr
    ...
    <Modal
      ...
      :width="modal.width"
    >
      <CourseTime v-if="modal.type === 'CourseTime' && modal.show" />
      <ClassRoomList v-if="modal.type === 'ClassRoomList' && modal.show" />
      <Course v-if="modal.type === 'Course' && modal.show" />
    </Modal>
  </div>
</template>
...
<script>
  ...
  export default {
    name: 'CourseTable',
    components: { CourseTime, ClassRoomList, Course },
    props: {
      memberInfo: {
        type: Object,
        default: () => {},
    ...
    methods: {
      ...
      save() {},
      setHeight() {
        let divHeight = window.innerHeight - 250
