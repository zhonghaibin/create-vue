<template>
  <div class="box">
    ...
    <div class="list">
      <Table :columns="columns" :data="list">
        ...
        <template slot="action">
          <div class="bt">库存明细</div>
          <div class="bt" @click="showModal('保质期明细', 'ShelfLifeList')">
            保质期明细
          </div>
          <div class="bt">修改库存下限</div>
          <div class="bt">修改预警值</div>
        </template>
      </Table>
      <div class="page">
        <Page
    ...
    <Modal
      ...
      :width="modal.width"
    >
      <ShelfLifeList v-if="modal.type === 'ShelfLifeList' && modal.show" />
    </Modal>
  </div>
</template>
