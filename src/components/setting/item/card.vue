<template>
  <div class="Card">
    ...
    >
      <div class="brawer">
        <p class="text">套餐名称:套餐名称不要翻过50个字。</p>
        <p class="text">适用门店:设置哪些门店可以经营该套餐。</p>
        <p class="text">
          统一售价:若存在不同门店不同的定价,请展开按门店设置价格。
        </p>
        <p class="text">套餐分类:(推荐完善)方便收银和设置卡的时候快速筛选。</p>
        <p class="text">套餐内容:选择当前套餐涵盖哪些项目/商品。</p>
        <p class="text">
          购卡账送:可以选择设置购买该套餐次卡系统自动票送的内容,可以是另一张或储值卡,或项目/商品
        </p>
        <p class="text">
          套餐状态: 上架:可以在系统中售卖该套餐 下架:不可在系统中售卖该套餐
        </p>
        <p class="text">套餐配图:针对线上商城首图</p>
        <p class="text">
          套餐详情:针对该套餐的详情介绍,可文字、图片,主要在的城展示
        </p>
      </div>
    </Drawer>
  </div>
