<template>
  <div class="StoreTargetList">
    ...
    <Modal
      ...
      :width="modal.width"
    >
      <StoreTarget v-if="modal.type === 'StoreTarget' && modal.show" />
      <StoreTargetDetails
        v-if="modal.type === 'StoreTargetDetails' && modal.show"
      />
    </Modal>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    components: { StoreTarget, StoreTargetDetails },
    props: {
      memberInfo: {
        type: Object,
        default: () => {},
    ...
    methods: {
      ...
      save() {},
      setHeight() {
        let divHeight = window.innerHeight - 340
