<template>
  <div class="StoreTargetDetails">
    <div class="content">
      <div class="row">
        <div class="left">
          <div>门店：</div>
        </div>
        <div class="right">惠城总店</div>
      </div>
      <div class="row">
        <div class="left">
          <div>2021年1月业绩目标：</div>
        </div>
        <div class="right">10000元</div>
      </div>
      <div class="box">
        ...
        <div v-for="(item, index) in list" :key="index" class="cell">
          <div class="row">
            ...
            <div class="right">2022-5-1-2022-5-15</div>
          </div>
          <div class="row">
            <div class="left">
            ...
            <div class="right">
              50%
              <span class="color">目标：50000.00</span>
            </div>
          </div>
          <div class="row">
            <div class="left">
